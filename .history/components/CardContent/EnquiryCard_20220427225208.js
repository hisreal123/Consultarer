...
export const EnquiryCard = () => {
  return (
    <div className=" bg-white shadow-lg relative  hover:scale-105 transition grid ">
      {Enquiry.map((data, i) => (
        <div className="cardWrap  relative lg:grid-cols-4 grid" key={i}>
          ...
          <div className="btm mt-4 mb-4 px-4">
            <Link href="#" alt="">
              <a className=" flex relative items-center text-xs truncate ">
                <Profile position="relative w-7 mr-2 lg:grid"  appear="hidden"/>
                {data.username}
              </a>
            </Link>
