  ...
  return (
    <div className={` cardWrapper `}>
      <div className="cardContent relative ">
        <div className="details relative flex flex-col grid-cols-1  lg:gap-5 gap-3 ">
          {User.map((user, slug) => (
            <div
              className={` user relative flex flex-col grid grid-cols-2 bg-white py-2 lg:px-5 px-4 shadow-lg ${userStyle}`}
              key={slug}
            >
