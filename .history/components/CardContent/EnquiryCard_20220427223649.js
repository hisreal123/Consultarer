...
export const EnquiryCard = () => {
  return (
    <div className=" bg-white shadow-lg relative  hover:scale-105 transition overflow-hidden pb-10">
      {Enquiry.map((data, i) => (
        <div className="cardWrap  relative" key={i}>
          <Link href="#" alt="EnquiryLink">
            <a className="h-[100px] relative">
              <div className="top w-100 max-h-[100px] relative  mb-[50px]">
                <Image
