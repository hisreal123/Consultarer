  ...
  return (
    <div className={` cardWrapper `}>
      <div className="cardContent relative  overflow-scroll">
        <div className="details relative grid grid-cols-4 md:grid-cols-4 gap-3 ">
          {User.map((user, slug) => (
            <div
              className={` user relative w-screen flex flex-col  bg-white py-2 lg:px-5 px-4 shadow-lg ${userStyle}`}
              key={slug}
            >
