  ...
  return (
    <div className={` cardWrapper `}>
      <div className="cardContent relative ">
        <div className="details relative grid  grid-cols-1 md:grid-cols-4 gap-3    ">
          {User.map((user, slug) => (
            <div
              className={` user relative flex flex-col  bg-white py-2 lg:px-5 px-4 shadow-lg hover:scale-105 transition${userStyle}`}
              key={slug}
            >
