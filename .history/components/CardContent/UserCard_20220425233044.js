  ...
  return (
    <div className="cardWrapper relative">
      <div className="cardContent">
        <div className=" details relative  grid grid-cols-4 gap-1">
          {User.map((user, slug) => (
            <div
              className={` user relative bg-red-500  ${inStyle}`}
              key={slug}
            >
              <div className="relative h-7 w-7 bg-red-300 flex flex-col">
                <Image
