  ...
  return (
    <div className="cardWrapper relative">
      <div className="cardContent">
        <div className=" details relative bg-red-500 grid grid-cols-4 gap-5">
          {User.map((user, slug) => (
            <div
              className={` user relative flex flex-col  ${inStyle}`}
              key={slug}
            >
              <div className="relative h-7 w-7 bg-red-300 ">
                <Image
