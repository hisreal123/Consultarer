...
export const Aside = ({ toggleStyle }) => {
  ...
  return (
    <div
      className={`h-screen bg-white  absolute top-0 bottom-0 left-0  shadow-lg overflow-hidden w-3/4  trabstion
    ...
    >
      <div className="top  ">
        <div className="top flex  justify-between items-center py-2 px-2">
          ...
          <GrFormClose className="text-3xl" onClick={() => setOpenedAside(!OpenedAside)} />
        </div>
        <Divider />
