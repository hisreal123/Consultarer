...
const Search = ({ widthStyle, mobileStyle, inputStyle , lgStyle}) => {
  return (
    <div
      className={`transition hover:shadow-md  flex items-center  relative  bg-white lg:bg-[#d1cdcd] justify-between pr-3 lg:rounded-lg group ${widthStyle} ${mobileStyle} ${lgStyle}`}
    >
      <input
        type="text"
        name="search"
