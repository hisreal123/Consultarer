      ...
      <ul>
        <li className=" w-screen bg-red-200">
          <Link href="/#" passHref={true} className="group">
            <a className="  relative lg:flex lg:flex-col lg:items-center 
            lg:hover:text-black focus:text-red-400 lg:text-gray-600 lg:text-xs  transition  lg:hover:border-b-2  lg:hover:border-black lg:border-b-white">
