  ...
  return (
    <div className=" shadow-sm ">
      ...
      <div className=" relative lg:flex item-center ">
        <TopNavMobile />
        <div className="wrap hidden lg:flex  lg:bg-white lg:w-screen   ">
          <Search
            widthStyle="  ml-4 rounded-full hidden md:block lg:mr-1 lg:flex lg:pr-2  lg:pt-3 lg:bg-[#ad8080] lg:text-white l"
