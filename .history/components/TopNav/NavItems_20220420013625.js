        ...
        <li className=" w-screen ">
          <Link href="/#" passHref={true} className="group">
            ...
            lg:hover:text-black focus:text-red-400 lg:text-gray-600 lg:text-xs  transition  
              lg:hover:border-b-2  lg:hover:border-black lg:border-b-white py-3 lg:py-0 w-screen"
            >
              <span className="lg:hover:text-green lg:block lg:lg:p-3  ">
                <p className="hidden">{icon}</p>
                {status}
              </span>
              <span className="font-normal hover:scale-105 transition-all text-left w-screen md:w-auto ml-2 ">
                {title}
              </span>
            </a>
          </Link>
