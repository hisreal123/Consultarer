...
export const TopNav = () => {
  ...
  return (
    <div className=" shadow-lg max-h-[100] relative ">
      <div className=" relative container mx-auto flex items-center w-screen  h-full justify-between">
        <div className="logo relative  ">
          <Logo className="text-9xl fit" />
        </div>
        ...
        {/* NAv right*/}
        <div className="nav inline-flex text-center flex-1 mx-10 justify-between items-baseline bg-red-900 h-100">
          <NavItems
            title="Welcome"
