...
// svg-icons
import { FaBeer } from "react-icons/lib/cjs/iconBase";
...
export const TopNav = () => {
  const IcconStyle = "text-[30px]";

  return (
    <div className="bg-red-300">
      <div className=" relative container mx-auto flex items-center w-screen bg-red-200 justify-between">
        <Logo className="text-8xl p-0 m-0 ml-4" />
        ...
        <div className="nav inline-flex text-center flex-1 mx-10 justify-between ">
          <NavItems title="Welcome" icon={<FaBeer className={IcconStyle} />} />
