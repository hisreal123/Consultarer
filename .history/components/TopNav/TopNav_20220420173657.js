...
export const TopNav = () => {
  ...
  return (
    <div className=" shadow-lg ">
      <div className=" relative container mx-auto md:flex items-center w-screen md:justify-between">
        <div className="logo relative flex  px-1 w-full  bg-red-200">
          ...
          <div className="relative self-end">
            ...
            <span className="bg-green-600 h-3 w-3 absolute z-10 bottom-0   rounded-full right-0 "></span>
          </div>
        </div>
