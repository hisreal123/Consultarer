      ...
      <div className=" relative container mx-auto ">
        ...
        {!Open ? (
          ...
          <div className=" transition-all ">
            ...
            <NavItems title="Hub" icon={<MdOutlineCoronavirus className={IcconStyle} />} />

            <NavItems
              title="Notification"
              icon={<MdOutlineNotificationsActive className={IcconStyle} />}
            />

            <NavItems
              title="Message"
              icon={<BsChat className={IcconStyle} />}
            />

            <NavItems
              title="Favourite"
              icon={<BsHeart className={IcconStyle} />}
            />
