    ...
    <div className=" shadow-lg ">
      <div className=" relative container mx-auto ">
        ...
        <div className="mobile relative ">
          <div className=" relative flex justify-between items-center bg-white w-screen pl-1">
            ...
            <div className="absolute right-0 pr-1 ">
              ...
              <span className="bg-green-600 h-2 w-2 absolute z-10 bottom-1 right-1  rounded-full "></span>
            </div>
          </div>
        ...
        {/* Search Comonent */}
        <Search widthStyle="w-screen ml-4 hover:text-green-400 rounded-full di " />
        {/* NAv right*/}
        {!Open ? (
          " "
        ) : (
