...
const Search = ({ widthStyle, mobileStyle, inputStyle , lgStyle}) => {
  return (
    <div
      className={`transition hover:shadow-md  flex items-center  relative  bg-white  justify-between pr-3 lg:mb-2 lg:rounded-lg group  ${widthStyle} ${mobileStyle} ${lgStyle}`}
    >
      <input
        type="text"
        name="search"
