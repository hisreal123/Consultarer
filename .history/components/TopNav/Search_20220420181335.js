...
const Search = ({ widthStyle, mobileStyle,  inputStyle }) => {
  return (
    <div
      className={`transition hover:shadow-md  flex items-center  relative rounded  bg-white lg:bg-[#E9E1E1] justify-between pr-3 lg:rounded-lg group ${widthStyle} ${mobileStyle}`}
    >
      <input
        type="text"
        name="search"
