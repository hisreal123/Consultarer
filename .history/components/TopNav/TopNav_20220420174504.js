  ...
  return (
    <div className=" shadow-lg ">
      <div className=" relative container mx-auto ">
        {/* mobile*/}
        <div className=" relative flex justify-between items-center bg-green-200 w-screen pl-1">
          ...
          <div className="absolute right-0 pr-1 ">
            ...
            <span className="bg-green-600 h-2 w-2 absolute z-10 bottom-1 right-1   rounded-full right-0 "></span>
          </div>
        </div>
        {/* Search Comonent */}
