  ...
  return (
    <div className=" shadow-lg ">
      <div className=" relative container mx-auto md:flex items-center w-screen justify-between">
        <div className="logo relative flex justify-between items-center bg-white mx-2 w-full md:w-auto overflow-hidden">
        ...
        {!Open ? (
          ...
          <div className="nav md:inline-flex justify-start bg-red-200 w-screen md:text-center md:flex-1 md:mx-10 md:justify-between transition">
            <NavItems
              title="Welcome"
