      ...
      <ul>
        <li>
          <Link href="/#" passHref={true} className="group ">
            <a className="lg:flex lg:flex-col lg:items-center hover:text-black bg-red-300 mt-0 lg:text-gray-600 lg:text-xs  trasition lg:hover:border-b-2  lg:border-black">
