  ...
  return (
    <div className=" shadow-lg ">
      <div className=" relative container mx-auto flex items-center w-screen justify-between">
        ...
        {/* NAv right*/}
        <div className=" flex flex-col nav md:inline-flex md:text-center md:flex-1 md:mx-10 md:justify-between">
          <NavItems
            title="Welcome"
          ...
          <NavItems title="Message" icon={<BsChatFill className={IcconStyle} />} />

          <NavItems title="Favourite" icon={<AiFillHeart className={IcconStyle} />} />
