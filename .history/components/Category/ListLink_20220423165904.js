...
const ListLink = ({ data }) => {
  ...
  return (
    <div className="relative bg-[#EBEBEB]  ">
      <ul className=" w-full  relative flex whitespace-nowrap px-10 sm:px-20 space-x-10 sm:space-x-20 overflow-x-scroll scrollbar-hide py-2 md:text-lg lg:w-screen">
        {data.map((list) => (
          <li
            key={list.id}
