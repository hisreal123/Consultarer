  ...
  return (
    <div className=" group md:flex md:items-center md:justify-between md:w-full relative   lg:justify-between lg:items-center">
      {AsideLink.map((item) => (
        ...
        >
          <span className="mr-2 sm:hover:text-red-400 lg:hover:text-black lg:hover:font-extrabold lg:hover:scale-150 transition duration-100 lg:hover:animate-bounce">
            {item.icon}
          </span>
